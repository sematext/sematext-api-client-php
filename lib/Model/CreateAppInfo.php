...
class CreateAppInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'initial_plan_id' => 'int',
        'meta_data' => '\Swagger\Client\Model\AppMetadata',
        'name' => 'string'
    ];
     ...
     * Gets meta_data
     *
     * @return \Swagger\Client\Model\AppMetadata
     */
     ...
     * Sets meta_data
     *
     * @param \Swagger\Client\Model\AppMetadata $meta_data AWS app meta data. Applicable only for `aws` appType
     *
     * @return $this
     */
