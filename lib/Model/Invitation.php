...
class Invitation implements ModelInterface, ArrayAccess
{
     ...
     * Sets app
     *
     * @param \Swagger\Client\Model\App $app For invite request, only app.id needs to be set.
     *
     * @return $this
     */
     ...
     * Sets apps
     *
     * @param \Swagger\Client\Model\App[] $apps For invite request, only apps.id needs to be set.
     *
     * @return $this
     */
