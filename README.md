...
# Sematext Cloud - API Client - sematext-api-php
...
*MetricsApi* | [**listDataSeriesUsingPOST1**](docs/Api/MetricsApi.md#listdataseriesusingpost1) | **POST** /spm-reports/api/v3/apps/{appId}/metrics/data | Get metrics data points for an app
...
*MetricsApi* | [**listMetricsKeysUsingGET1**](docs/Api/MetricsApi.md#listmetricskeysusingget1) | **GET** /spm-reports/api/v3/apps/{appId}/metrics/keys | Get metrics keys for an app
