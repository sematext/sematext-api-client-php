...
class BillingApi
{
     ...
     */
    public function updatePlanUsingPUT1($body, $app_id)
    {
        list($response) = $this->updatePlanUsingPUT1WithHttpInfo($body, $app_id);
        return $response;
    }

    /**
     * Operation updatePlanUsingPUT1WithHttpInfo
     *
     * Update plan for an app
     *
     * @param  \sematext\stcloud\Model\BillingInfo $body dto (required)
     ...
     */
    public function updatePlanUsingPUT1WithHttpInfo($body, $app_id)
    {
        $returnType = '\sematext\stcloud\Model\UpdatePlanResponse';
        $request = $this->updatePlanUsingPUT1Request($body, $app_id);
    ...
    /**
     * Operation updatePlanUsingPUT1Async
     *
     * Update plan for an app
     *
     * @param  \sematext\stcloud\Model\BillingInfo $body dto (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePlanUsingPUT1Async($body, $app_id)
    {
        return $this->updatePlanUsingPUT1AsyncWithHttpInfo($body, $app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updatePlanUsingPUT1AsyncWithHttpInfo
     *
     * Update plan for an app
     *
     * @param  \sematext\stcloud\Model\BillingInfo $body dto (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePlanUsingPUT1AsyncWithHttpInfo($body, $app_id)
    {
        $returnType = '\sematext\stcloud\Model\UpdatePlanResponse';
        $request = $this->updatePlanUsingPUT1Request($body, $app_id);
    ...
    /**
     * Create request for operation 'updatePlanUsingPUT1'
     *
     * @param  \sematext\stcloud\Model\BillingInfo $body dto (required)
     * @param  int $app_id appId (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePlanUsingPUT1Request($body, $app_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updatePlanUsingPUT1'
            );
        }
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling updatePlanUsingPUT1'
            );
        }
