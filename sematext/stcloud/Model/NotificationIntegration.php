...
class NotificationIntegration implements ModelInterface, ArrayAccess
{
    ...
    public const APPLICABILITY_NONE = 'NONE';
    public const APPLICABILITY_USE_ALWAYS = 'USE_ALWAYS';
    public const INTEGRATION_TYPE_PAGER_DUTY = 'PAGER_DUTY';
    public const INTEGRATION_TYPE_NAGIOS = 'NAGIOS';
    public const INTEGRATION_TYPE_WEB_HOOKS = 'WEB_HOOKS';
    public const INTEGRATION_TYPE_WEB_HOOKS_TEMPLATE = 'WEB_HOOKS_TEMPLATE';
    public const INTEGRATION_TYPE_HIP_CHAT = 'HIP_CHAT';
    public const INTEGRATION_TYPE_EMAIL_LIST = 'EMAIL_LIST';
    public const INTEGRATION_TYPE_TEMPORARY_EMAIL_LIST = 'TEMPORARY_EMAIL_LIST';
