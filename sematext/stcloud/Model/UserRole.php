...
class UserRole implements ModelInterface, ArrayAccess
{
    ...
    public const ROLE_STATUS_INACTIVE = 'INACTIVE';
     ...
     * @return string[]
     */
    public function getRoleStatusAllowableValues()
    {
        return [
            self::ROLE_STATUS_INACTIVE,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getRoleStatusAllowableValues();
        if (!is_null($this->container['role_status']) && !in_array($this->container['role_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'role_status', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets role_status
     *
     * @param string $role_status role_status
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getRoleStatusAllowableValues();
        if (!is_null($role_status) && !in_array($role_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'role_status', must be one of '%s'",
                    implode("', '", $allowedValues)
