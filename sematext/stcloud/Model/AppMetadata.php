...
class AppMetadata implements ModelInterface, ArrayAccess
{
    ...
    public const AWS_FETCH_FREQUENCY_MINUTE = 'MINUTE';
    public const AWS_FETCH_FREQUENCY_FIVE_MINUTES = 'FIVE_MINUTES';
    public const AWS_FETCH_FREQUENCY_FIFTEEN_MINUTES = 'FIFTEEN_MINUTES';
    public const AWS_REGION_US_EAST_1 = 'US_EAST_1';
    public const AWS_REGION_US_WEST_1 = 'US_WEST_1';
    public const AWS_REGION_EU_WEST_1 = 'EU_WEST_1';
    public const AWS_REGION_US_WEST_2 = 'US_WEST_2';
    public const AWS_REGION_AP_SOUTHEAST_1 = 'AP_SOUTHEAST_1';
    public const AWS_REGION_AP_SOUTHEAST_2 = 'AP_SOUTHEAST_2';
    public const AWS_REGION_AP_NORTHEAST_1 = 'AP_NORTHEAST_1';
    public const AWS_REGION_SA_EAST_1 = 'SA_EAST_1';
    public const AWS_REGION_GOV_CLOUD = 'GovCloud';
    public const AWS_REGION_CN_NORTH_1 = 'CN_NORTH_1';
    public const AWS_REGION_US_EAST_2 = 'US_EAST_2';
    public const AWS_REGION_AP_SOUTH_1 = 'AP_SOUTH_1';
    public const AWS_REGION_AP_NORTHEAST_2 = 'AP_NORTHEAST_2';
    public const AWS_REGION_CA_CENTRAL_1 = 'CA_CENTRAL_1';
    public const AWS_REGION_EU_CENTRAL_1 = 'EU_CENTRAL_1';
    public const AWS_REGION_EU_WEST_2 = 'EU_WEST_2';
    public const SUB_TYPES_EC2 = 'aws_ec2';
    public const SUB_TYPES_ELB = 'aws_elb';
    public const SUB_TYPES_EBS = 'aws_ebs';
