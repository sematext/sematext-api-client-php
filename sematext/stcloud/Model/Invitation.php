...
class Invitation implements ModelInterface, ArrayAccess
{
    ...
    public const INVITE_STATUS_CANCELLED = 'CANCELLED';
    public const INVITE_STATUS_DECLINED = 'DECLINED';
    public const INVITEE_ROLE_SUPER_USER = 'SUPER_USER';
    public const INVITEE_ROLE_OWNER = 'OWNER';
    public const INVITEE_ROLE_ADMIN = 'ADMIN';
    public const INVITEE_ROLE_USER = 'USER';
    public const INVITEE_ROLE_DEMO = 'DEMO';
    public const INVITEE_ROLE_ANONYMOUS = 'ANONYMOUS';
    public const INVITEE_STATUS_INACTIVE = 'INACTIVE';
    public const INVITEE_STATUS_ACTIVE = 'ACTIVE';
