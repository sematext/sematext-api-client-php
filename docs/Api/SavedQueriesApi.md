# Swagger\Client\SavedQueriesApi
...
> \Swagger\Client\Model\GenericApiResponse deleteSavedQueryUsingDELETE($updateable_query_id)
...
$apiInstance = new Swagger\Client\Api\SavedQueriesApi(
...
> \Swagger\Client\Model\GenericApiResponse getSavedQueriesForAppUsingGET($app_id)
...
# **saveQueryUsingPOST**
> \Swagger\Client\Model\GenericApiResponse saveQueryUsingPOST($saved_query_dto)
...
$saved_query_dto = new \Swagger\Client\Model\SavedQuery(); // \Swagger\Client\Model\SavedQuery | savedQueryDto
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **saved_query_dto** | [**\Swagger\Client\Model\SavedQuery**](../Model/SavedQuery.md)| savedQueryDto |
...
# **saveQueryUsingPUT**
> \Swagger\Client\Model\GenericApiResponse saveQueryUsingPUT($saved_query_dto, $updateable_query_id)
