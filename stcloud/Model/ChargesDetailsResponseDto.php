...
'usage_amount' => 'getUsageAmount'    ];
    ...
    const CHARGE_BASE_SUMMARIZED_USAGE = 'SUMMARIZED_USAGE';
const CHARGE_BASE_MIN_MONTHLY_FEE = 'MIN_MONTHLY_FEE';
const CHARGE_BASE_SUM_OF_DAILY_FEES = 'SUM_OF_DAILY_FEES';
const CHARGE_BASE_TOTAL_MONTHLY_FEE = 'TOTAL_MONTHLY_FEE';
