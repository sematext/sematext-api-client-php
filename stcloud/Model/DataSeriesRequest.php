...
class DataSeriesRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'end' => 'string',
        'filters' => 'map[string,\sematext\stcloud\Model\DataSeriesFilter]',
        'granularity' => 'string',
        'interval' => 'string',
        'metric' => 'string',
        'start' => 'string'
     ...
     * Gets filters
     *
     * @return map[string,\sematext\stcloud\Model\DataSeriesFilter]
     */
     ...
     * Sets filters
     *
     * @param map[string,\sematext\stcloud\Model\DataSeriesFilter] $filters Map of allowed filter values and aggregation strategy. List of available filter values can be fetched using metric filters endpoint and default aggregation strategy depends on metric
     *
     * @return $this
     */
